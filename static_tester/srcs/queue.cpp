...
void test_queue()
{
	...
	using X = NAMESPACE::queue<ValueType, Container>;
	using Xint = NAMESPACE::queue<int>;
	...
	a.front();
	static_assert(std::is_same<decltype(a.front()), typename X::container_type::value_type &>::value, "wrong return type for front");
	const_a.front();
	static_assert(std::is_same<decltype(const_a.front()), const typename X::container_type::value_type &>::value, "wrong return type for front on const container");

	a.back();
	static_assert(std::is_same<decltype(a.back()), typename X::container_type::value_type &>::value, "wrong return type for back");
	const_a.back();
	static_assert(std::is_same<decltype(const_a.back()), const typename X::container_type::value_type &>::value, "wrong return type for back on const container");
